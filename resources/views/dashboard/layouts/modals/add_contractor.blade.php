    ...
    <div class="modal-dialog mt-5" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('company-store') }}" enctype="multipart/form-data">
                ...
                <input type="hidden" value="contractor" name="new_company_type">
                    ...
                    <div class="tab-content p-0" id="myTabContent">
                        ...
                        <div class="tab-pane modal-content-max-height pt-0 fade" id="create-new-contractor" role="tabpanel" aria-labelledby="create-new-contractor-tab">
                            ...
                            <div class="col-12">
                                <h4>Quotation*</h4>
                                <div class="form-group">
                                    <input type="text" name="new_company_total_price" placeholder="Enter total price..." value="{{ old('new_company_total_price') }}" class="form-control{{ $errors->has('new_company_total_price') ? '  is-invalid' : '' }}" autocomplete="off">
                                    @if ($errors->has('new_company_total_price'))
                                        <span class="help-block invalid-feedback d-block">
                                            <strong>{{ $errors->first('new_company_total_price') }}</strong>
                                        </span>
                                    @endif        
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group{{ $errors->has('new_company_quote') ? ' has-error' : '' }}">
                                    @if ($errors->has('new_company_quote'))
                                        <span class="help-block invalid-feedback d-block">
                                            <span class="badge badge-danger text-white mr-2">Error : </span>
                                            <strong>{{ $errors->first('new_company_quote') }}</strong>
                                        </span>
                                    @endif  
                                    <input type="file" data-max-file-size="2mb" data-default-file="{{ old('new_company_quote') }}" data-height="100"
                                    class="dropify form-control {{ $errors->has('new_company_quote') ? ' is-invalid' : '' }}" name="new_company_quote">                                      
                                </div>
                            </div>
